...
public class AiBackgroundTask extends Worker {

    private static final String TAG = "AiBackgroundTask";

    private ArrayList<Article> articles;
    public AiBackgroundTask(@NonNull Context context, @NonNull WorkerParameters workerParams) {
...
//
        ...
        db.articleDao().deleteArticlesByCategory("AI/ML");
        ...
        while (parser.next() != XmlPullParser.END_TAG){
            ...
            while (parser.next() != XmlPullParser.END_TAG) {
                ...
                if (parser.getName().equals("item")){
                    ...
                    Article article = new Article(title, date, description, link, "AI/ML");
    ...
    private InputStream getInputStream() throws java.net.SocketTimeoutException{
        try {
            URL url = new URL("https://www.technologyreview.com/feed");
