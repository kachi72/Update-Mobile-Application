...
public class DataScienceBackgroundTask extends Worker {

    private static final String TAG = "DataScienceBackgroundTask";

    private ArrayList<Article> articles;
    public DataScienceBackgroundTask(@NonNull Context context, @NonNull WorkerParameters workerParams) {
...
//
        ...
        db.articleDao().deleteArticlesByCategory("Data Science");
        ...
        while (parser.next() != XmlPullParser.END_TAG){
            ...
            while (parser.next() != XmlPullParser.END_TAG) {
                ...
                if (parser.getName().equals("item")){
                    ...
                    Article article = new Article(title, date, description, link, "Data Science");
    ...
    private InputStream getInputStream() throws java.net.SocketTimeoutException{
        try {
            URL url = new URL("https://www.kdnuggets.com/tag/data-science/feed");
