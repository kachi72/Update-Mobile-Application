...
public class SoftwareBackgroundTask extends Worker {

    private static final String TAG = "SoftwareBackgroundTask";

    private ArrayList<Article> articles;
    public SoftwareBackgroundTask(@NonNull Context context, @NonNull WorkerParameters workerParams) {
...
//
        ...
        db.articleDao().deleteArticlesByCategory("Software Engineering");
        ...
        while (parser.next() != XmlPullParser.END_TAG){
            ...
            while (parser.next() != XmlPullParser.END_TAG) {
                ...
                if (parser.getName().equals("item")){
                    ...
                    Article article = new Article(title, date, description, link, "Software Engineering");
    ...
    private InputStream getInputStream() throws java.net.SocketTimeoutException{
        try {
//            URL url = new URL("https://feed.infoq.com/");
            URL url = new URL("https://www.toptal.com/blog.rss");
