...
public class NetworkBackgroundTask extends Worker {

    private static final String TAG = "NetworkBackgroundTask";

    private ArrayList<Article> articles;
    public NetworkBackgroundTask(@NonNull Context context, @NonNull WorkerParameters workerParams) {
...
//
        ...
        db.articleDao().deleteArticlesByCategory("Networking");
        ...
        while (parser.next() != XmlPullParser.END_TAG){
            ...
            while (parser.next() != XmlPullParser.END_TAG) {
                ...
                if (parser.getName().equals("item")){
                    ...
                    Article article = new Article(title, date, description, link, "Networking");
    ...
    private InputStream getInputStream() throws java.net.SocketTimeoutException{
        try {
//            URL url = new URL("https://blog.flashrouters.com/feed/");
            URL url = new URL("https://blogs.cisco.com/networking/feed");
