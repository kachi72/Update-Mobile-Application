...
public class OfflineCyberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_offline_cyber);
    ...
    private void initWorker() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                articles = db.articleDao().getArticlesByCategory("CyberSecurity");
                if (articles.isEmpty()){
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        @Override
                        public void run() {
                            hideLoadingIcon();
                            Toast.makeText(OfflineCyberActivity.this, "There are no saved posts in the database for this category", Toast.LENGTH_LONG).show();
                            showNoArticleText();
                        }
                    });
                }
