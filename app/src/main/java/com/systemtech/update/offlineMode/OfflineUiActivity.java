...
public class OfflineUiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_offline_ui);
    ...
    private void initWorker() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                articles = db.articleDao().getArticlesByCategory("UI/UX");
                if (articles.isEmpty()){
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        @Override
                        public void run() {
                            hideLoadingIcon();
                            Toast.makeText(OfflineUiActivity.this, "There are no saved posts in the database for this category", Toast.LENGTH_LONG).show();
                            showNoArticleText();
                        }
                    });
                }
